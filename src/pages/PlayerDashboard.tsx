...
import {
  ...
  CheckCircle, XCircle, Clock, AlertTriangle, MessageSquare, Send, MessageCircle
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="flex gap-1 bg-white border border-gray-200 rounded-xl p-1 mb-6 overflow-x-auto">
          ...
          <Link
            to="/player/chat"
            className="flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-all whitespace-nowrap flex-shrink-0"
          >
